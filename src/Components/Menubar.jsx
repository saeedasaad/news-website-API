...
export default function Menubar() {
    ...
    return (
        <>
            ...
            {/* Slide Menu */}
            {isOpen && (
                <div className="fixed top-3 left-34  h-[230px] w-[200px] z-[999] bg-white border-1 border-solid border-[#38383822] shadow-lg shadow-[#dc959e42] p-5 flex flex-col gap-6 transition-all duration-300">
